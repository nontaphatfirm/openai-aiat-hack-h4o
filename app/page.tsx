...
export default function LandingPage() {
  return (
    <main className="min-h-full bg-white px-4 pb-8 pt-6">
      <section className="rounded-3xl bg-slate-950 px-5 py-7 text-white shadow-sm">
        <p className="mb-4 w-max rounded-full bg-teal-400/15 px-3 py-1 text-xs font-bold text-teal-200">
        ...
        <p className="mt-4 text-sm leading-6 text-slate-300">
          WellnessApp combines your health passport, daily wearable signals, environment,
      ...
      <section className="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50 p-5">
        <h2 className="text-lg font-extrabold text-emerald-950">Today&apos;s mock snapshot</h2>
